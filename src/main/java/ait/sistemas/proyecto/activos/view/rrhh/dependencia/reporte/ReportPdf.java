package ait.sistemas.proyecto.activos.view.rrhh.dependencia.reporte;
...
public class ReportPdf {
    ...
    static final String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Dependencia.pdf";
    ...
    private static Table createContent(String[][] data) {
        ...
        columns.add(new Column("Nombre Dependencia", 150));
        columns.add(new Column("Sigla", 60));
        columns.add(new Column("Domicilio", 150));
        columns.add(new Column("Telefono", 80));
