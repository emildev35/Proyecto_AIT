...
public class FormRevaloriza extends GridLayout implements TextChangeListener{
			...
			public void handleAction(Object sender, Object target) {
				...
				try {
					...
					ActivoInventario activo = new ActivoInventario(Long.parseLong(txtcodigo.getValue().replace(".", "")
							.replace("'", "")), txtnombre_activo.getValue(),new BigDecimal (txtnuevo_valor.getValue()),Integer.parseInt(txtnueva_vida_util
							.getValue()));
	...
	public Movimiento getData() {
		...
		for (Object row : grid_revaloriza.getSelectedRows()) {
			...
			detalle.setNuevo_valor(new BigDecimal(txtnuevo_valor.getValue()));
			detalle.setNueva_vida_util(Integer.parseInt(txtnueva_vida_util.getValue()));
