package ait.sistemas.proyecto.activos.view.para.tiposact.reporte;
...
public class ReportPdf {
    ...
    static final String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Tipos-Activos.pdf";
    ...
    private static Table createContent(String[][] data) {
        ...
        columns.add(new Column("Nombre Tipo Activo", 420));
