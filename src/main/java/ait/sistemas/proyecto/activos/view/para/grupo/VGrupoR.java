...
public class VGrupoR extends VerticalLayout implements View, ClickListener {
	...
	public VGrupoR() {
		...
		msgs.add(new BarMessage("", "Pulsar el Boton Imprimir para generar el reporte"));
		buildMessages(msgs);
	}
	...
	public String[][] getData() {
		...
		for (GruposContablesModel row_mov : result) {
			String[] row = { String.valueOf(row_mov.getGRC_Grupo_Contable()), row_mov.getGRC_Nombre_Grupo_Contable(),
					String.valueOf(row_mov.getGRC_Partida()), String.valueOf(row_mov.getGRC_Vida_Util()),
