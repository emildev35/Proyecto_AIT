...
public class VKardexR extends VerticalLayout implements View, ClickListener {
	...
	public KardexElement[][][] getData(List<ActivosModel> lista) {
		...
		for (ActivosModel activos : lista) {
			...
			kardex_elements[r][3][4].setContenido(String.valueOf(activos.getACT_Fecha_Compra()));
			...
			kardex_elements[r][4][6].setContenido(String.valueOf(activos.getACT_Fecha_Vencimiento_Mantenimiento()));
