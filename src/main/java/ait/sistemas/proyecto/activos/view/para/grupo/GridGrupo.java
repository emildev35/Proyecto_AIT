...
public class GridGrupo extends Grid{
	...
	public void buildGrid(){
		bean_grupo = new BeanItemContainer<GruposContablesModel>(
		...
		setColumnOrder("GRC_Grupo_Contable","GRC_Nombre_Grupo_Contable", "GRC_Vida_Util","GRC_Coeficiente","GRC_Partida");
