package ait.sistemas.proyecto.activos.view.rrhh.unidad.reporte;
...
public class ReportPdf {
    ...
    static final String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Unidad.pdf";
    ...
    private static Table createContent(String[][] data) {
        ...
        columns.add(new Column("Dependencia", 180));
        columns.add(new Column("Codigo", 60));
        columns.add(new Column("Unidad Organizacional", 190));
