...
public class ReportPdf {
    ...
    static final String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Partidas-Presupuestarias.pdf";
    ...
    private static Table createContent(String[][] data) {
        ...
        columns.add(new Column("Nombre de Partidas Presupuestarias", 420));
        ...
        Table table = new TableBuilder()
            ...
            .setUsuario("XXXXXX")
            .setTitle("PARTIDAS PRESUPUESTARIAS")
            .setSubTitle("")
            .build();
        return table;
    }   
