...
import com.vaadin.ui.TextField;
	...
	public class FormOrganismo extends GridLayout implements ValueChangeListener{
		...
		public FormOrganismo() {
			...
			this.txt_nombre_organismo.addValidator(new StringLengthValidator(Messages.STRING_LENGTH_MESSAGE(3, 60), 3,60,false));
			this.txt_id_organismo.setEnabled(false);	
			
			txt_id_organismo.setWidth("90%");
			txt_nombre_organismo.setWidth("90%");
