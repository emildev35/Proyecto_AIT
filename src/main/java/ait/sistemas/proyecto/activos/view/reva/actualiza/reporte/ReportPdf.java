...
public class ReportPdf {
	...
	private Table createContent(String[][] content, String strDependencia) {
		...
		columns.add(new Column("Nombre del Activo", 70));
		columns.add(new Column("Fecha Compra", 60));
		columns.add(new Column("Valor Compra", 55));
		columns.add(new Column("Vida Util", 35));
		columns.add(new Column("Valor Actualizado Gestion Anterior", 100));
		columns.add(new Column("Depreciacion Actualizada Gestion Anterior", 100));
		columns.add(new Column("Valor Neto", 50));
