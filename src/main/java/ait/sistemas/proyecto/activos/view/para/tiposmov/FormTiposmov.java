...
/**
 * Formulario de Tipos de Movimiento
 * @author franzemil
 *
 */
public class FormTiposmov extends GridLayout implements ValueChangeListener {
	...
	public FormTiposmov() {
		...
		pitm_Tiposmov.addItemProperty("id_tiposmov", new ObjectProperty<String>(""));
		...
		this.txt_sigla_tiposmov.addValidator(new StringLengthValidator(Messages.STRING_LENGTH_MESSAGE(2, 11), 2, 11, false));
