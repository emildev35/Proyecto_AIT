...
public class VMotivobajaB extends VerticalLayout implements View, SelectionListener, ClickListener,
	...
	private void eliminar() {
		try {
			...
			Notification.show(Messages.FOREIGN_RELATION_ERROR(frm_motivo.txt_nombre_motivo_baja.getValue()), Type.ERROR_MESSAGE);
		}
