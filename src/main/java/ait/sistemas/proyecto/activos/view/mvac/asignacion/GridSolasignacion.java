...
public class GridSolasignacion extends Grid{
	...
	private BeanItemContainer<SolicitudGrid> bean_Movimiento;
	...
	public void buildGrid(){
		bean_Movimiento = new BeanItemContainer<SolicitudGrid>(SolicitudGrid.class);
		bean_Movimiento.addAll(acta_impl.getSolicitudAsignacion((int)1));
...
//		removeColumn("idUnidadOrganizacional");
