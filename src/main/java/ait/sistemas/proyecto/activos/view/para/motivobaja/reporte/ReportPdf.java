...
public class ReportPdf {
    ...
    static final String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Motivo-Baja.pdf";
    ...
    private static Table createContent(String[][] data) {
        ...
        columns.add(new Column("Codigo Motivo", 60));	
        columns.add(new Column("Nombre Motivo de Baja", 420));
