...
public class PdfReport {
	...
	public String SAVE_PATH = PathValues.PATH_REPORTS + String.valueOf(new Date().getTime()) + ".pdf";
	
	public boolean getPdf(String[][] data) throws IOException {
		SAVE_PATH = PathValues.PATH_REPORTS + String.valueOf(new Date().getTime()) + ".pdf";
		return new InventarioGrupoGenerator().generatePDF(createContent(data), SAVE_PATH);
