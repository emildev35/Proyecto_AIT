package ait.sistemas.proyecto.activos.view.inve.activosinasig;
...
import ait.sistemas.proyecto.activos.view.inve.inventario.FormInventario;
...
public class VActivoSinasigR extends VerticalLayout implements View, ClickListener {
	...
	public String[][] getDatos() {
		...
		List<ActivosModel> lista = activo_impl.activosingasig_by_dependencia((Short) this.frmReporte.cb_Dependencia.getValue(),
				new java.sql.Date(this.frmReporte.dt_fecha.getValue().getTime()));
		...
		for (ActivosModel activo : lista) {
			String[] row = { activo.getACT_Dependencia(), activo.getACT_Grupo_Contable(), activo.getACT_Auxiliar_Contable(),
					activo.getACT_Codigo_Activo(), activo.getACT_No_Serie(), activo.getACT_Nombre_Activo(),
					String.valueOf(activo.getACT_Valor_Compra()), String.valueOf(activo.getACT_Valor_Neto()),
					String.valueOf(activo.getACT_Vida_Residual()) };
	...
	public String[][] getDatosALL() {
		List<ActivosModel> lista = activo_impl.getActivosbyFechaCompraSinasig(new java.sql.Date(this.frmReporte.dt_fecha
				.getValue().getTime()));
