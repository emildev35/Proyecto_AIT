...
@CDIView(value = VReporteInventarioconso.ID)
public class VReporteInventarioconso extends VerticalLayout implements View, ClickListener {

	private static final long serialVersionUID = 1L;
	public static final String ID = "/act/inve/inventarioconso/reporte";
	...
	public VReporteInventarioconso() {
