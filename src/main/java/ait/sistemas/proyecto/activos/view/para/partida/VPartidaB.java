...
public class VPartidaB extends VerticalLayout implements View, SelectionListener, ClickListener,
	...
	private void eliminar() {
		try {
			...
			Notification.show(Messages.FOREIGN_RELATION_ERROR(frm_partida.txt_nombre_partida.getValue()),
					Type.ERROR_MESSAGE);
		}
