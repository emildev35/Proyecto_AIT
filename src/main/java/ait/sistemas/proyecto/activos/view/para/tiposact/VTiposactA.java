...
import com.vaadin.ui.VerticalLayout;
	...
	@CDIView(value = VTiposactA.ID)
	public class VTiposactA extends VerticalLayout implements View, ClickListener {

		private static final long serialVersionUID = 1L;
		public static final String ID = "/act/para/tiposact/a";
		...
		public void buttonClick(ClickEvent event) {
			if (event.getButton() == this.btn_agregar) {
				if(this.frm_tiposact.validate()){
					this.tiposact_impl.add(this.frm_tiposact.getData());
					grid_tiposact.update();
					this.frm_tiposact.update();
					this.frm_tiposact.updateId();
