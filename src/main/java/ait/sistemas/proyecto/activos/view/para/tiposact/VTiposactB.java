...
public class VTiposactB extends VerticalLayout implements View, SelectionListener, ClickListener,
	...
	private void eliminar() {
		try {
			...
			Notification.show(Messages.FOREIGN_RELATION_ERROR(frm_tiposact.txt_nombre_tiposact.getValue()), Type.ERROR_MESSAGE);
		}
