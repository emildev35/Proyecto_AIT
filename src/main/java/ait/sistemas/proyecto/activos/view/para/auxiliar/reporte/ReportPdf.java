...
public class ReportPdf {
    ...
    static String SAVE_PATH = "C:\\Editores\\Reportes\\Informe-Auxiliares-Contables.pdf";
    
    
    public boolean getPdf(String[][] data,String str_Grupo) throws IOException{
    	
 
        return new PDFTableGenerator().generatePDF(createContent(data, str_Grupo), SAVE_PATH);
        
    }

    private static Table createContent(String[][] data , String str_Grupo) {
        List<Column> columns = new ArrayList<Column>();
        columns.add(new Column("Codigo Grupo", 75));	
        columns.add(new Column("Nombre Grupo Contable", 160));
        columns.add(new Column("Codigo Auxiliar", 75));
        columns.add(new Column("Nombre Auxiliar Contables", 160));
        ...
        Table table = new TableBuilder()
            ...
            .setUsuario("XXXXXX")
            .setTitle("AUXILIARES CONTABLES")
            .setSubTitle("Grupo Contable : " + str_Grupo)
            .build();
        return table;
    }   
}
