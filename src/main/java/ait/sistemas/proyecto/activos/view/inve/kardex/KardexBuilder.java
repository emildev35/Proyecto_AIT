...
public class KardexBuilder {
	...
	public KardexBuilder setNumberOfRowsComponentes(Integer numberOfRows) {
		kardex.setNumberOfRowsComponentes(numberOfRows);
		return this;
	}
	public KardexBuilder setNumberOfRowsDocumentos(Integer numberOfRows) {
	...
	public KardexBuilder setComponentes(String[][] componentes) {
		kardex.setComponentes(componentes);
		return this;
	}

	public KardexBuilder setDocumentos(String[][] documentos) {
		kardex.setDocumentos(documentos);
		return this;
	}
	public KardexBuilder setColumnsComponentes(List<Column> columnsComponentes){
		kardex.setColumns_componentes(columnsComponentes);
		return this;
	}
	public KardexBuilder setColumnsDocumentos(List<Column> columnsDocumentos){
