...
public class Historico {
	...
	private HisotricoElement[][] elementos;
	...
	public HisotricoElement[][] getElementos() {
		return elementos;
	}

	public void setElementos(HisotricoElement[][] elementos) {
	...
	public HisotricoElement[][] getElemenos() {
		return elementos;
	}

	public void setElemenos( HisotricoElement[][] elemenos) {
