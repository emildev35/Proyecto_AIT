...
@CDIView(value = VTiposmovB.URL)
@SuppressWarnings("unused")
public class VTiposmovB extends VerticalLayout implements View,
		SelectionListener, ClickListener,
		org.vaadin.dialogs.ConfirmDialog.Listener {

	private static final long serialVersionUID = 1L;
	public static final String URL = "/act/para/tiposmov/b";
	...
	private Tipos_Movimiento tipomov;
	...
	public void select(SelectionEvent event) {
		...
		if ((Tipos_Movimiento) this.grid_tiposmov.getSelectedRow() != null) {
			this.frm_tiposmov.setData((Tipos_Movimiento) this.grid_tiposmov
					.getSelectedRow());
		}
	}
	...
	private void eliminar() {
		try {
			this.tipos_impl.deletes(this.frm_tiposmov.getData()
					.getTMV_Tipo_Movimiento());
			this.frm_tiposmov.update();
