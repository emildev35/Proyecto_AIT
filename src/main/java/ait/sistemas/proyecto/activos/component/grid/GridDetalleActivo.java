...
//		nombre_activo.setHeaderCaption("Nombre Activo");
	...
	public void update(long nro_documento, short id_dependencia){
		removeAllColumns();
		this.bean_detalles = new BeanItemContainer<Detalle>(Detalle.class, movimientoimpl.getDetallesbyMovimiento(nro_documento, id_dependencia));
		setContainerDataSource(bean_detalles);
