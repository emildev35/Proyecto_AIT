...
public class FormSubMenu extends GridLayout implements Property.ValueChangeListener{
	...
	public FormSubMenu() {
		...
		this.txt_nombre_menu.addValidator(new StringLengthValidator(Messages.STRING_LENGTH_MESSAGE(3, 25), 3,25,false));
	...
	public void GenerarIds() {
		...
		this.txt_id_submenu.setValue(this.menuimpl.generateSubMenuId(
