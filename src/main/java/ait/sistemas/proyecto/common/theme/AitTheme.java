package ait.sistemas.proyecto.common.theme;


public class AitTheme {
	
	
	public static final String PANEL_GRID = "ait-pn-grid";
	public static final String PANEL_FORM = "ait-pn-frm";
	public static final String PANEL_PRINT = "ait-pn-print";
	
	public static final String BTN_SUBMIT = "ait-btn-submit";
	public static final String BTN_EXIT = "ait-btn-exit";
